...
install_singbox() {
    ...
    latest_version=$(curl -s "https://api.github.com/repos/SagerNet/sing-box/releases" | jq -r '[.[] | select(.prerelease==true)][0].tag_name | sub("^v"; "")')
   ...
   # 生成随机端口和密码
    ...
    openssl req -new -x509 -days 3650 -key "${work_dir}/private.key" -out "${work_dir}/cert.pem" -subj "/CN=mesu.apple.com"
